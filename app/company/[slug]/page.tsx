...
type RelatedArticle={_id:string;_updatedAt:string;title:string;slug:string;publishedAt?:string;seoDescription?:string;mainImage?:{asset?:ImageSource;alt?:string};category?:{title?:string;slug?:string}};
