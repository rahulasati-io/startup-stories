...
export default function PersonCard({ person }: { person: DirectoryPerson }) {
  return (
    <Link href={`/founder/${person.slug}`} className="group rounded-2xl border border-zinc-200 bg-white p-5 transition hover:-translate-y-0.5 hover:border-zinc-300 hover:shadow-md">
